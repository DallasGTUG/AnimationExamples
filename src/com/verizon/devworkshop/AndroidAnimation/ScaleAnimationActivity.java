...
public class ScaleAnimationActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_scale);
    ...
    public static Animation runAnimation(Activity ctx, View target)
    {
    	 ...
    	 Animation animation = AnimationUtils.loadAnimation(ctx, R.anim.scale);
	...
	public OnClickListener mOnApply = new OnClickListener()
	{
		...
		public void onClick(View v) {
			runAnimation(ScaleAnimationActivity.this, animationImage);
		}
