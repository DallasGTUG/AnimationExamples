...
public class FireBallAnimationActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_fireball);
    ...
    public static Animation runAnimation(Activity ctx, View target)
    {
    	 ...
    	 Animation animation = AnimationUtils.loadAnimation(ctx, R.anim.fireball_animation);
	...
	public OnClickListener mOnApply = new OnClickListener()
	{
		...
		public void onClick(View v) {
			runAnimation(FireBallAnimationActivity.this, animationImage);
